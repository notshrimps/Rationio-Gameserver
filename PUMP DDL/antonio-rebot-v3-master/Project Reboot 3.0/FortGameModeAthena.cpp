...
bool AFortGameModeAthena::Athena_ReadyToStartMatchHook(AFortGameModeAthena* GameMode)
{
	...
	if (AmountOfRestarts != LastNum3)
	{
		...
		UptimeWebHook.send_message(std::format("<@&1155524485546512435> Server up! Version {}, Gamemode: {}, Bus will be leaving in 2 minutes!", Fortnite_Version, GetPlaylistProperName())); // PlaylistName sometimes isn't always what we use!
