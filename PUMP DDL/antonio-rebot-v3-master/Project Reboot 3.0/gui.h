...
extern inline float AutoBusStartSeconds = 120;
...
static inline std::string Version = "1.0.4";
...
static inline void Shutdownembed()
{
	std::string json = R"()"; // in the () put your json code for embed

	// Debug output
	std::cout << "Sending JSON: " << json << std::endl;
	LOG_INFO(LogDev, "Sending JSON: {}", json);

	// Send the embed JSON
	UptimeWebHook.send_embedjson(json);
}
...
static inline void MainTabs()
{
	...
	if (ImGui::BeginTabBar(""))
	{
		...
		if (false, ImGui::BeginTabItem("Players"))
		{
			Tab = PLAYERS_TAB;
			ImGui::EndTabItem();
		}
...
static inline DWORD WINAPI LateGameThread(LPVOID)
{
	...
	*/
	...
	for (int z = 0; z < ClientConnections.Num(); z++)
	{
		...
		UFortItemDefinition* firstslot = nullptr;
		UFortItemDefinition* secondslot = nullptr;
		UFortItemDefinition* thirdslot = nullptr;
		UFortItemDefinition* foruthslot = nullptr;
		UFortItemDefinition* fifthslot = nullptr;
		UFortItemDefinition* trapfslot = nullptr;

		int randomIndex = dist(gen);
		switch (randomIndex)
		{
		case 0:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_Auto_Athena_R_Ore_T03.WID_Assault_Auto_Athena_R_Ore_T03");
			break;
		case 1:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_AutoHigh_Athena_SR_Ore_T03.WID_Assault_AutoHigh_Athena_SR_Ore_T03");
			break;
		case 2:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_Auto_Athena_R_Ore_T03.WID_Assault_Auto_Athena_R_Ore_T03");
			break;
		case 3:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_AutoHigh_Athena_VR_Ore_T03.WID_Assault_AutoHigh_Athena_VR_Ore_T03");
			break;
		case 4:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_AutoHigh_Athena_SR_Ore_T03.WID_Assault_AutoHigh_Athena_SR_Ore_T03");
			break;
		case 5:
			...
			break;
		case 6:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_SemiAuto_Athena_R_Ore_T03.WID_Assault_SemiAuto_Athena_R_Ore_T03");
			break;
		case 7:
			firstslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Assault_SemiAuto_Athena_VR_Ore_T03.WID_Assault_SemiAuto_Athena_VR_Ore_T03");
			break;
		default:
			break;
		}
		...
		{
		case 0:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_Standard_Athena_C_Ore_T03.WID_Shotgun_Standard_Athena_C_Ore_T03"); 
			break;
		case 1:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_SlugFire_Athena_VR.WID_Shotgun_SlugFire_Athena_VR"); 
			break;
		case 2:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_Standard_Athena_UC_Ore_T03.WID_Shotgun_Standard_Athena_UC_Ore_T03"); 
			break;
		case 3:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_BreakBarrel_Athena_VR_Ore_T03.WID_Shotgun_BreakBarrel_Athena_VR_Ore_T03");
			break;
		case 4:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_SlugFire_Athena_VR.WID_Shotgun_SlugFire_Athena_VR"); 
			break;
		case 5:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_SemiAuto_Athena_R_Ore_T03.WID_Shotgun_SemiAuto_Athena_R_Ore_T03");
			break;
		case 6:
			secondslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Shotgun_Standard_Athena_UC_Ore_T03.WID_Shotgun_Standard_Athena_UC_Ore_T03"); 
			break;
		...
		{
		case 0: 
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_NoScope_Athena_R_Ore_T03.WID_Sniper_NoScope_Athena_R_Ore_T03"); 
			break;
		case 1:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_VR_Ore_T03.WID_Sniper_Heavy_Athena_VR_Ore_T03"); 
			break;
		case 2:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_SR_Ore_T03.WID_Sniper_Heavy_Athena_SR_Ore_T03"); 
			break;
		case 3:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_BoltAction_Scope_Athena_VR_Ore_T03.WID_Sniper_BoltAction_Scope_Athena_VR_Ore_T03"); 
			break;
		case 4:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_BoltAction_Scope_Athena_SR_Ore_T03.WID_Sniper_BoltAction_Scope_Athena_SR_Ore_T03"); 
			break;
		case 5:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_Standard_Scope_Athena_VR_Ore_T03.WID_Sniper_Standard_Scope_Athena_VR_Ore_T03");
			break;
		case 6:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_NoScope_Athena_R_Ore_T03.WID_Sniper_NoScope_Athena_R_Ore_T03");
			break;
		case 7:
			thirdslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_Standard_Scope_Athena_SR_Ore_T03.WID_Sniper_Standard_Scope_Athena_SR_Ore_T03");
			break;
		default:
			break;
		}
		...
		{
		case 0:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/ShieldSmall/Athena_ShieldSmall.Athena_ShieldSmall"); 
			break;
		case 1:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/ShockwaveGrenade/Athena_ShockGrenade.Athena_ShockGrenade"); 
			break;
		case 2:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/StickyGrenade/Athena_StickyGrenade.Athena_StickyGrenade"); 
			break;
		case 3:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/GasGrenade/Athena_GasGrenade.Athena_GasGrenade"); 
			break;
		case 4:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/ShieldSmall/Athena_ShieldSmall.Athena_ShieldSmall");
			break;
		case 5:
			...
			break;
		case 6:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/Grenade/Athena_Grenade.Athena_Grenade");
			break;
		case 7:
			foruthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/ShieldSmall/Athena_ShieldSmall.Athena_ShieldSmall");
			break;
		...
		{
		case 0:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Hook_Gun_VR_Ore_T03.WID_Hook_Gun_VR_Ore_T03"); 
			break;
		case 1:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Launcher_Military_Athena_VR_Ore_T03.WID_Launcher_Military_Athena_VR_Ore_T03"); 
			break;
		case 2:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Launcher_Grenade_Athena_R_Ore_T03.WID_Launcher_Grenade_Athena_R_Ore_T03"); 
			break;
		case 3:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Launcher_Rocket_Athena_VR_Ore_T03.WID_Launcher_Rocket_Athena_VR_Ore_T03");
			break;
		case 4:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Launcher_Grenade_Athena_R_Ore_T03.WID_Launcher_Grenade_Athena_R_Ore_T03"); 
			break;
		case 5:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Launcher_Military_Athena_SR_Ore_T03.WID_Launcher_Military_Athena_SR_Ore_T03");
			break;
		case 6:
			fifthslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Hook_Gun_VR_Ore_T03.WID_Hook_Gun_VR_Ore_T03");
			break;
		...
		{
		case 0:
			trapfslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Traps/TID_Floor_Player_Launch_Pad_Athena.TID_Floor_Player_Launch_Pad_Athena"); 
			break;
		case 1:
			trapfslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Traps/TID_Context_BouncePad_Athena.TID_Context_BouncePad_Athena"); 
			break;
		case 2:
			trapfslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Traps/TID_Context_BouncePad_Athena.TID_Context_BouncePad_Athena"); 
			break;
		case 3:
			trapfslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Traps/TID_ContextTrap_Athena.TID_ContextTrap_Athena");
			break;
		case 4:
			trapfslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Traps/TID_Floor_Player_Campfire_Athena.TID_Floor_Player_Campfire_Athena"); 
			break;
		case 5:
			trapfslot = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Traps/TID_Floor_Player_Campfire_Athena.TID_Floor_Player_Campfire_Athena"); 
			break;
		...
		static auto Rocket = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Ammo/AmmoDataRockets.AmmoDataRockets");

		if (firstslot != nullptr)
		{
			WorldInventory->AddItem(firstslot, nullptr, 1);
			WorldInventory->AddItem(secondslot, nullptr, 1);
			WorldInventory->AddItem(thirdslot, nullptr, 1);
			WorldInventory->AddItem(foruthslot, nullptr, 6);
			WorldInventory->AddItem(fifthslot, nullptr, 1);
			WorldInventory->AddItem(trapfslot, nullptr, 3);
			...
			WorldInventory->AddItem(Shells, nullptr, 40);
			WorldInventory->AddItem(Medium, nullptr, 500);
			WorldInventory->AddItem(Light, nullptr, 300);
			WorldInventory->AddItem(Heavy, nullptr, 50);
			WorldInventory->AddItem(Rocket, nullptr, 10);
...
static inline void MainUI()
{
	...
	if (PlayerTab == -1)
	{
		...
		if (Tab == GAME_TAB)
		{
			if (bLoaded)
			{
				...
				*/
				...
				if (Globals::SupportMoreVersions == true && ImGui::Button("Restart"))
				{
						if (IsRestartingSupported)
						{
							Restart();
					...
					{
						if (!bIsInAutoRestart && Engine_Version < 425 && ImGui::Button("Restart"))
						{
							...
							{
								ImGui::Text("Enable AutoRestart for this version(untested) to use this function!");
		...
		else if (Tab == GAMEMODE_TAB) 
		{
			...
			{
				PlaylistName = "/Game/Athena/Playlists/Playground/Playlist_Playground.Playlist_Playground";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("PlaygroundV2"))
			{
				PlaylistName = "/Game/Athena/Playlists/Creative/Playlist_PlaygroundV2.Playlist_PlaygroundV2";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Solid Gold(Solos)"))
			{
				PlaylistName = "/Game/Athena/Playlists/HighExplosives/Playlist_HighExplosives_Solo.Playlist_HighExplosives_Solo";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Solid Gold(Squads)"))
			{
				PlaylistName = "/Game/Athena/Playlists/HighExplosives/Playlist_HighExplosives_Squads.Playlist_HighExplosives_Squads";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Sniper Shootout(Solos)"))
			{
				PlaylistName = "/Game/Athena/Playlists/Snipers/Playlist_Snipers_Solo.Playlist_Snipers_Solo";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Sniper Shootout(Duos)"))
			{
				PlaylistName = "/Game/Athena/Playlists/Snipers/Playlist_Snipers_Duos.Playlist_Snipers_Duos";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Floor is lava(Solos) (not working)"))
			{
				PlaylistName = "/Game/Athena/Playlists/Fill/Playlist_Fill_Solo.Playlist_Fill_Solo";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Floor is lava(Duos) (not working)"))
			{
				PlaylistName = "/Game/Athena/Playlists/Fill/Playlist_Fill_Duos.Playlist_Fill_Duos";
				if (IsRestartingSupported)
				{
					Restart();
				}
			...
			if (ImGui::Button("Floor is lava(Squads) (crashes on restart sometimes)"))
			{
				PlaylistName = "/Game/Athena/Playlists/Fill/Playlist_Fill_Squads.Playlist_Fill_Squads";
				if (IsRestartingSupported)
				{
					Restart();
				}
...
else if (Tab == PLAYERS_TAB)
{
	...
	// ImGui::Text(AlivePlayers.Num());
		 ...
		 else if (Tab == SOLARDEVELOPER_TAB)
		 {
			 if (!IsRestartingSupported)
			 {
				 ...
				 {
					 Globals::SupportMoreVersions = true;
					 IsRestartingSupported();
				 }
			 }
			 if (ImGui::Button("Check Game version support")) 
			 {
				 if (Fortnite_Version > 1.11 && Fortnite_Version < 12.20) 
				 {
					 ImGui::Text("Current Game version is fully compatible with AutoRestart.");
				 }
				 else 
				 {
					 ImGui::Text("Current Game version is not compatible with AutoRestart.");
				 }
 ...
 {
	 ImGui::Text("Created by https://github.com/Antonio0447, AutoRestart, Vbucks on kill/win, and more.");
	 ImGui::Text("[+] Change log %s: ", Version.c_str());
	 ImGui::Text("Added support up to s12.20");
	 ImGui::Text("fixed crashing in s6");
	 ImGui::Text("improved ui");
	 ImGui::Text("removed Player Tab due to crashing");
...
static inline DWORD WINAPI GuiThread(LPVOID)
{
	...
	::RegisterClassEx(&wc);
	HWND hwnd = ::CreateWindowExW(0L, wc.lpszClassName, L"Pump", (WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX), 100, 100, Width, Height, NULL, NULL, wc.hInstance, NULL);
	...
	while (!done)
	{
		...
		{
			std::string windowTitle = "Project Solar " + Version;
			ImGui::Begin(windowTitle.c_str(), nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar);
